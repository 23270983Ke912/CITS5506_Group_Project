...
urlpatterns = [
    ...
    url(r'emergencyevent/edit/$', views.EmergencyEventEditView.as_view(), name='event_edit'),
    url(r'userinfo/$', views.UserView.as_view(), name='user_profile'),
]
