...
public class BluetoothPairActivity extends Activity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lvNewDevices.setOnItemClickListener(BluetoothPairActivity.this);
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
        ...
        mBluetoothAdapter.cancelDiscovery();
        Toast.makeText(this, "Stop scaning", Toast.LENGTH_LONG).show();
        ...
        if(Build.VERSION.SDK_INT > Build.VERSION_CODES.JELLY_BEAN_MR2){
            ...
            MyAlertDialog.setTitle("Pair Complete");
